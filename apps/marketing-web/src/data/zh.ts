// marketing-web 中文内容（zh-CN 默认 locale）。公开落地页（漏斗顶部）。所有能力文案锚定
// docs/PRODUCT_REQUIREMENTS.md，严守首版诚实边界：无后台轮询 / OS 唤醒 / Cloud Relay / 无人值守执行 /
// 自动下架；平台账号身份与凭据永不离开设备；云同步是强制异步复制（无永久纯本地模式），
// Desktop 业务先写本地数据库，并可在已验证离线授权窗口内继续运行；最多两台设备、单 Active；
// publish/公开展示是未来功能，不宣传。定价与 account-web 一致。
//
// 文案语气：面向客户、结果导向。不用开发者术语（无「凭据/回滚/增量同步/轮询/Punycode/
// Priority-0/Active 设备/非秘密业务数据」）。技术准确性不变，用日常语言表达。
...
export const meta: PageMeta = {
  ...
  description:
    "从 Spaceship、Namecheap 等注册商统一管理域名，批量上架到 Atom、Afternic 等销售平台，自动完成平台验证，一键同步价格。平台密码始终留在你的电脑上。macOS 与 Windows 桌面软件。",
  ogLocale: "zh_CN",
  ogTitle: "GoodDealer — 域名批量管理软件",
  ogDescription: "多注册商域名统一管理，批量上架、自动验证、价格同步。平台密码始终留在你的电脑上。",
  twitterTitle: "GoodDealer — 域名批量管理软件",
  twitterDescription: "多注册商域名统一管理，批量上架、自动验证、价格同步。密码不上云。",
  jsonLd: [
    {
      ...
      description:
        "域名批量管理桌面软件。从多个注册商统一管理域名资产，批量上架到销售平台，自动完成平台验证，一键同步价格。平台密码始终留在本地。",
      offers: [
        { "@type": "Offer", price: "9.80", priceCurrency: "USD", name: "月付" },
        { "@type": "Offer", price: "98.00", priceCurrency: "USD", name: "年付" },
        { "@type": "Offer", price: "498.00", priceCurrency: "USD", name: "终身买断" },
      ],
    },
    {
      "@context": "https://schema.org",
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "不会。首版软件不会在后台自动运行。当你主动刷新，或其他操作过程中发现域名已售出时，软件会生成跨平台下架清单，由你逐次确认后执行。",
          },
        },
        {
          "@type": "Question",
          name: "平台账号密码和 API Key 会上传吗？",
          acceptedAnswer: {
            "@type": "Answer",
            text: "不会。平台账号资料、连接名称、密码、API Key 和登录会话始终留在你的电脑上，GoodDealer 云端和运营后台都无法读取；云端只保存允许同步的域名、价格等业务副本。",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "最多两台电脑，任何时候只有一台能执行操作，另一台只能查看。换第三台需先解绑旧设备。",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "注册商以 Spaceship 起步，DNS 支持 Cloudflare 与注册商自带 DNS，销售平台覆盖 Atom、SellerHub、Afternic；未接入的注册商可通过导入文件补充。",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "没有永久纯本地模式：云同步会自动复制允许同步的业务副本，供另一台电脑恢复和查看。但桌面客户端始终先把业务变更写入本机加密数据库；完成账号与设备授权后，在已验证的离线授权窗口内仍可继续本地业务，网络恢复后再同步排队变更。平台账号资料、密码、API Key 和浏览器会话只留在本机。",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "终身买断一次付费，不再扣费，包含所有未来大版本更新。月付和年付可随时取消，到期后不再续费。",
          },
        },
      ],
    },
...
export const data: MkData = {
  ...
  faq: [
    ...
    { q: "平台账号密码和 API Key 会上传吗？", a: "不会。平台账号资料、连接名称、密码、API Key 和登录会话始终留在你的电脑上，GoodDealer 云端和运营后台都无法读取；云端只保存允许同步的域名、价格等业务副本。" },
    ...
    { q: "有纯本地、不联网的模式吗？", a: "没有永久纯本地模式：云同步会自动复制允许同步的业务副本，供另一台电脑恢复和查看。但桌面客户端始终先把业务变更写入本机加密数据库；完成账号与设备授权后，在已验证的离线授权窗口内仍可继续本地业务，网络恢复后再同步排队变更。平台账号资料、密码、API Key 和浏览器会话只留在本机。" },
    { q: "买断之后还会扣费吗？", a: "终身买断一次付费，不再扣费，包含所有未来大版本更新。月付和年付可随时取消，到期后不再续费。" },
  ],
  download: {
    title: "在你的电脑上开始",
    sub: "支持 macOS 与 Windows。下载后登录账号、绑定设备，即可开始管理域名。",
    platforms: [
      ["macOS", "下载 for macOS"],
      ["Windows", "下载 for Windows"],
    ],
    note: "首次使用需登录账号并绑定设备；域名与价格等数据同步到云端，密码留在本地。",
  },
  // 支持平台 — every platform name is an SEO anchor. Honesty: gold marks the release target
  // (subject to compatibility & safety gates), not current availability.
  platforms: {
    registrars: {
      title: "域名注册商",
      sub: "读取域名资产、到期日、锁定状态与 DNS 信息",
      items: [
        { name: "Spaceship", releaseTarget: true },
        { name: "Namecheap", releaseTarget: true },
        { name: "Dynadot", releaseTarget: true },
        { name: "阿里云(万网)", releaseTarget: true },
        { name: "GoDaddy" },
        { name: "Porkbun" },
        { name: "Namesilo" },
        { name: "Name.com" },
    ...
    dns: {
      title: "DNS 管理平台",
      sub: "添加验证记录、等待生效、避免覆盖邮件设置",
      items: [
        { name: "Cloudflare", releaseTarget: true },
        { name: "注册商自带 DNS", releaseTarget: true },
        { name: "AWS Route 53" },
  ...
  ui: {
    ...
    showcase: {
      ...
      aggDomain: "域名",
      aggRegistrar: "注册商",
      aggNote: "连接注册商即批量拉取 · 整批沿线汇入 · 一次插入多行",
      listWin: "批量上架 · 域名 × 平台",
      listListed: "在售 ✓",
      listDone: "已上架 12 项 · 3 平台",
      listBody: ["把选中的 ", "4", " 个域名上架到 Atom · SellerHub · Afternic 共 ", "3", " 个销售平台。"],
      listConfirm: "确认提交",
      listNote: "提交任务后软件自动跨平台上架 · — 未上架，在售 ✓ 已上架",
      verifyWin: "自动执行平台验证",
      verifyHead: "· 软件为一批域名自动跑平台验证",
      verifyDomain: "域名",
      verifyPlatform: "销售平台",
      verifyStatus: "验证",
      verifyWait: "待验证",
      verifyIng: "验证中 · 写 TXT",
      verifyOk: "已验证",
      verifyNote: "软件自动写入验证记录、等待生效、确认通过 · 不用逐个手动操作",
      syncWin: "价格同步 · 改一次价",
      syncNote: "改一次价 · 脉冲沿辐条射向各平台与设备 · 逐个同步",
    },
