...
// 自动下架；凭据永不离开设备；云同步是基础能力（无纯本地模式）；最多两台设备、单 Active；
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "不会。密码和登录信息始终留在你的电脑上，GoodDealer 云端和运营后台都无法读取。API Key 由你在软件的安全输入框中录入；云端只同步域名、价格等业务数据。",
          },
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "没有。云同步是基础功能，用于两台设备之间保持数据一致和查看；平台密码仍然只在本地。",
          },
        },
        {
          "@type": "Question",
