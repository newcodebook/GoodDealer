...
const requiredPaths = [
  ...
  "packages/connector-sdk/src/generated/endpoint-registry.ts",
  "packages/connector-sdk/endpoint-manifest.schema.json",
  "packages/connector-test-kit/src",
  "packages/connectors/spaceship/src",
  "packages/connectors/spaceship/endpoint-manifest.json",
  ...
  "crates/secure-host-core/src/generated/endpoint_registry.rs",
