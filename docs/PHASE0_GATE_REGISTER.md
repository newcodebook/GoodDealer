...
- P0-05 的 Portable 实现与总门禁已完成，关闭相关 Gate 前仍须取得锁定 Rust 工具链/native CI 的成功 evidence set、长期不可变归档与独立 Attestation。Connector 唯一注册边和其余信任域扫描仍属于 R0-15；只读 RuntimeStatus IPC 不等于 Auth DTO、业务 Command 或完整 RuntimeMode 资源准入已经交付。
