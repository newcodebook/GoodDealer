...
window.MK_DATA={
  lang:"en",assetBase:"../../",
  nav:[["features","Features"],["platforms","Platforms"],["demo","Demo"],["security","Security"],["pricing","Pricing"],["faq","FAQ"]],
  hero:{
  ...
  download:{title:"Get started on your computer",sub:"Available for macOS and Windows. Download, sign in, link your device, and start managing domains.",platforms:[["macOS","Download for macOS"],["Windows","Download for Windows"]],note:"First use requires signing in and linking a device. Domain and pricing data syncs to the cloud; passwords stay local."},
  platforms:{
    registrars:{title:"Domain Registrars",sub:"Read domain assets, expiry, lock status & DNS info",items:[
      {name:"Spaceship",releaseTarget:true},{name:"Namecheap",releaseTarget:true},{name:"Dynadot",releaseTarget:true},{name:"Alibaba Cloud (万网)",releaseTarget:true},
      {name:"GoDaddy"},{name:"Porkbun"},{name:"Namesilo"},{name:"Name.com"},{name:"Epik"},{name:"Cloudflare Registrar"},
      {name:"西部数码"},{name:"新网"},{name:"腾讯云"},
    ]},
    sales:{title:"Domain Sales Platforms",sub:"List, reprice, check status & verify ownership",items:[
    ...
    dns:{title:"DNS Management",sub:"Add verification records, wait for propagation, protect email settings",items:[
      {name:"Cloudflare",releaseTarget:true},{name:"Registrar-Native DNS",releaseTarget:true},
      {name:"AWS Route 53"},{name:"Google Cloud DNS"},{name:"Azure DNS"},{name:"DNSPod (Tencent Cloud)"},{name:"Alibaba Cloud DNS"},
    ]},
  },
  footer:{
  ...
  ui:{
    ...
    showcase:{tag:"Features",tagSub:"See them in action",h2:"Not concepts — working features in motion",
      aggWin:"Aggregate · Asset Library",aggSrc:"Domain Registrars",aggDomain:"Domain",aggRegistrar:"Registrar",aggNote:"Connect a registrar to pull domains in batch · whole batch arrives along the line · multi-row insert",
      listWin:"Bulk Listing · Domain × Platform",listListed:"Listed ✓",listDone:"Listed 12 items · 3 platforms",listBody:["List the selected ","4"," domains on Atom · SellerHub · Afternic across ","3"," sales platforms."],listConfirm:"Confirm",listNote:"After confirming, the software lists across platforms · — unlisted, Listed ✓ listed",
      verifyWin:"Auto-Verify Ownership",verifyHead:"· Software auto-verifies a batch of domains",verifyDomain:"Domain",verifyPlatform:"Sales Platform",verifyStatus:"Verify",verifyWait:"Pending",verifyIng:"Verifying · TXT",verifyOk:"Verified",verifyNote:"Auto-writes verification records, waits for propagation, confirms — no manual work",
      syncWin:"Price Sync · Change Once",syncNote:"Change once · pulse travels along spokes · synced one by one"},
    ...
    security:{tag:"Security Model",tagSub:"Passwords stay local · Cloud read-only",neverLeaves:"Never leaves this device",
