...
function SiteShell({children}){
  ...
  return <div className="mk">
    <header className="mk-top">
      <a href="#top" className="mk-brand"><img src="../../assets/logo/mark-flat.svg" width="20" height="20" alt=""/>GoodDealer</a>
      <nav className="mk-top-nav">
        {D.nav.map(([id,label])=><a key={id} href={"#"+id}>{label}</a>)}
      </nav>
      <div className="mk-top-right">
        <a href="../account-web/index.html">登录</a>
        <a href="#download" className="mk-stamp" style={{height:34,padding:"0 14px",fontSize:13}}><i></i>下载</a>
      </div>
    </header>
    ...
    <footer className="mk-foot">
      <div className="mk-foot-inner">
        <div style={{flex:"1 1 240px",minWidth:0}}>
          <div style={{display:"flex",alignItems:"center",gap:9,fontSize:15,fontWeight:600}}><img src="../../assets/logo/mark-flat.svg" width="18" height="18" alt=""/>GoodDealer</div>
      ...
      <div style={{maxWidth:1120,margin:"28px auto 0",paddingTop:16,borderTop:"1px solid var(--gd-line)",display:"flex",gap:14,flexWrap:"wrap",fontSize:11,color:"var(--text-3)"}}>
        <span>© 2026 GoodDealer</span><span>·</span><span>Paddle 为 Merchant of Record，结账不接触卡号</span><span>·</span><span>中文优先 · English 其次</span>
      </div>
    </footer>
  </div>;
}
